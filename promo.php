...
// Jika harga 0 (user akses langsung), beri nilai default atau redirect
if ($harga_asli <= 0) {
    // Opsional: Jika ingin tetap bisa akses tanpa redirect, hapus baris di bawah ini
    echo "<script>alert('Harga tidak valid. Harap pilih destinasi terlebih dahulu.'); window.location.href='destinasi.php';</script>";
    exit();
}
...
<script>
    ...
    function pilihPromo(kode) {
        ...
        let modalEl = document.getElementById('modalPromo');
