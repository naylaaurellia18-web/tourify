...
function getDBConn() {
    ...
    $connected = mysqli_real_connect(
        $conn, $host, $username, $password, $database, $port,
...
<head>
    ...
    <style>
        ...
        h3, .brand-title { font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; letter-spacing: -0.5px; }
        .login-container { max-width: 450px; width: 100%; margin: auto; padding: 20px; }
        .login-card { background: var(--white); border: 1px solid rgba(243,112,33,0.08); border-radius: 28px; box-shadow: 0 20px 40px rgba(243,112,33,0.04); padding: 40px 35px; }
        .nav-brand-box { display: flex; align-items: center; justify-content: center; gap: 10px; text-decoration: none; color: var(--text-dark) !important; }
        .brand-title { font-size: 1.75rem; line-height: 1; letter-spacing: -0.8px; }
        .logo-icon { width: 40px; height: 40px; background: linear-gradient(135deg, #f37021, #ff8c42); color: var(--white); border-radius: 12px; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 18px rgba(243,112,33,0.25); font-size: 1.1rem; }
        .form-control { border: 1px solid #e2e8f0; padding: 12px 16px; border-radius: 12px; font-size: 0.95rem; }
        .form-control:focus { border-color: var(--primary); box-shadow: 0 0 0 3px rgba(243,112,33,0.15); }
        .input-group-text { background: transparent; border-color: #e2e8f0; border-radius: 12px; color: var(--text-muted); }
        .btn-orange-vivid { background: var(--primary); border: none; color: white; font-weight: 700; padding: 14px; box-shadow: 0 8px 24px rgba(243,112,33,0.25); border-radius: 100px; }
        .btn-orange-vivid:hover { transform: translateY(-2px); box-shadow: 0 12px 30px rgba(243,112,33,0.4); color: white; }
    </style>
</head>
<body>
