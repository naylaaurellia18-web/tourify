<?php
// ============================================================
//  HALAMAN DESTINASI — Rasamadu (The Heritage Palace)
...
$nama_default      = 'Rasamadu (The Heritage Palace)';
$lokasi_default    = 'Sukoharjo';
$deskripsi_default = 'The Heritage Palace adalah bekas pabrik gula abad ke-19 yang disulap menjadi destinasi wisata bergaya Eropa klasik. Dengan arsitektur megah dan ratusan spot foto bertema, tempat ini jadi favorit untuk wisata keluarga maupun sesi foto pre-wedding.';
$harga_default     = 80000;
$gambar_default    = 'https://s-light.tiket.photos/t/01E25EBZS3W0FY9GTG6C42E1SE/rsfit19201280gsm/events/2026/03/25/a31c0d96-04af-41a3-bf0d-e6e1dd47f723-1774431846858-13592ce40930746e3e717f6e07e07d04.jpg';
$accent            = '#7c3aed';
$highlight_items   = ['Arsitektur gaya Eropa', 'Spot foto bersejarah', 'Wahana indoor & outdoor', 'Ramah keluarga'];
...
$kode_kabupaten_bps      = '3311'; // Kabupaten Sukoharjo
$nama_kabupaten_bps      = 'Kabupaten Sukoharjo';
...
<head>
    ...
    <style>
        ...
        .hero::after { content:''; position:absolute; inset:0; background:linear-gradient(180deg,rgba(15,23,42,0.05) 0%, rgba(15,23,42,0.75) 100%); pointer-events:none; }
