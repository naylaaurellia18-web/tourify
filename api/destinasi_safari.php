...
$nama_default      = 'Solo Safari';
$lokasi_default    = 'Surakarta';
$deskripsi_default = 'Solo Safari adalah kebun binatang modern dengan konsep edukasi satwa yang interaktif. Pengunjung dapat melihat satwa dari berbagai belahan dunia dalam habitat yang dirancang menyerupai aslinya, lengkap dengan area edukasi untuk anak-anak.';
$harga_default     = 60000;
$gambar_default    = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuZgalMALjLh8eeh4WdWlGIMKLeZ4RPPWGIg&s';
$accent            = '#16a34a';
$highlight_items   = ['Konsep edukasi satwa', 'Habitat menyerupai asli', 'Area interaktif anak', 'Feeding session harian'];
...
$kode_kabupaten_bps      = '3372'; // Kota Surakarta
$nama_kabupaten_bps      = 'Kota Surakarta';
