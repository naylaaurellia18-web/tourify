<?php
// ============================================================
//  HALAMAN DESTINASI — Saloka Theme Park
...
$deskripsi_default = 'Saloka Theme Park adalah taman rekreasi keluarga terbesar di Jawa Tengah, menghadirkan puluhan wahana seru mulai dari roller coaster, rumah hantu, hingga zona anak yang aman dan edukatif. Dirancang dengan tema lima zona budaya Nusantara, Saloka menggabungkan hiburan modern dengan kekayaan budaya lokal.';
$harga_default     = 120000;
$gambar_default    = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRZqPWsn-DyTw7qSrAjenFvPuQsrCvnKjMsw&s';
$accent            = '#f37021';
$highlight_items   = ['Roller coaster keluarga', '5 zona budaya Nusantara', 'Wahana anak & dewasa', 'Area foto Instagramable'];
